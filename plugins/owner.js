...
async (robin, mek, m, { from, isGroup, isAdmins, isBotAdmins, reply, quoted }) => {
    try {
        ...
        // Confirm the action
        return reply(`✅ Successfully removed ඔයාව ග්‍රප් එකෙන් අයින් කරනවා: @${target.split('@')[0]}`);
    } catch (e) {
...
async (robin, mek, m, { from, isGroup, isAdmins, isBotAdmins, reply, quoted }) => {
    try {
        ...
        // Confirm the action
        return reply(`✅ Successfully removed admin privileges from\n\n ඔයගේ ඇඩ්මින් අයින් කරා: @${target.split('@')[0]}`);
    } catch (e) {
...
async (robin, mek, m, { from, isGroup, isAdmins, isBotAdmins, reply, quoted }) => {
    try {
        ...
        // Confirm the action
        return reply(`✅ ඔයාට ඇඩ්මින් දුන්නා🥰\n\nnSuccessfully promoted @${target.split('@')[0]} to admin!`);
    } catch (e) {
